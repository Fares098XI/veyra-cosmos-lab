...
export default function Lesson9() {
  ...
  const handleSubmit = () => {
    ...
    const checks = [
      answers.q1 === "a",
      answers.q2 === "false",
      answers.q3?.toLowerCase().includes("clarif") || answers.q3?.toLowerCase().includes("calm") || answers.q3?.toLowerCase().includes("error"),
      answers.q4 === "a",
      answers.q5?.toLowerCase().includes("simul") || answers.q5?.toLowerCase().includes("practic") || answers.q5?.toLowerCase().includes("rehearsal")
    ];
