...
export default function Lesson7() {
  ...
  const handleSubmit = () => {
    ...
    const checks = [
      answers.q1 === "b",
      answers.q2 === "true",
      answers.q3?.toLowerCase().includes("simulates") || answers.q3?.toLowerCase().includes("weight"),
      answers.q4 === "b",
      answers.q5?.toLowerCase().includes("align") || answers.q5?.toLowerCase().includes("stab") || answers.q5?.toLowerCase().includes("rotate")
    ];
