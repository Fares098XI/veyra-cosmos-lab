...
export default function Lesson8() {
  ...
  const handleSubmit = () => {
    ...
    const checks = [
      answers.q1 === "c",
      answers.q2 === "false",
      answers.q3?.toLowerCase().includes("memory") || answers.q3?.toLowerCase().includes("muscle"),
      answers.q4 === "c",
      answers.q5?.toLowerCase().includes("simulation") || answers.q5?.toLowerCase().includes("surgery") || answers.q5?.toLowerCase().includes("aviation")
    ];
